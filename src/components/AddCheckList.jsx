...
const AddCheckList = () => {
	...
	useEffect(() => refList.current.value = '',[checkList]);

	return(

		<div className="modal">

			<div className="cross"><i onClick={() => setListModal(false)} className="bi-x"></i></div>
			
			<form className={`form-note ${conf.theme}`} onSubmit={saveNote}>
				...
				<div className="add-list-option">
					...
					<textarea className="add-el-list" ref={refList} type="text" placeholder="agregar elemento" disabled></textarea>
